...
PURPOSE: 
This Python console-based program is designed as a Hospital Management System. It allows users to register patients and doctors, manage appointments, confirm or cancel bookings, and generate patient bills. Its purpose is to reduce the challenge faced by users to maintain accurate patient records, coordinate doctor schedules, manage appointments and to handle billing procedures.

HOW TO RUN THE PROGRAM: 
In order to run the program, the following steps must be followed:
